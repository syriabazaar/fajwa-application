...
import static ae.gov.dubaipolice.fajwa.domain.DepartmentAsserts.*;
...
import ae.gov.dubaipolice.fajwa.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        return new Department().depName(DEFAULT_DEP_NAME);
    }
    ...
    public static Department createUpdatedEntity() {
        return new Department().depName(UPDATED_DEP_NAME);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.depName(UPDATED_DEP_NAME);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.depName(UPDATED_DEP_NAME);
