...
const baseApiUrl = 'api/appointments';

export default class AppointmentService {
  find(id: number): Promise<IAppointment> {
  ...
  update(entity: IAppointment): Promise<IAppointment> {
    return new Promise<IAppointment>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IAppointment): Promise<IAppointment> {
    return new Promise<IAppointment>((resolve, reject) => {
      axios
